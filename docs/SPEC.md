...
- AI機能（対話・返信生成・フォローアップ）使用ごとに1クレジット消費
- 毎月1日にリセット
- 80%到達時にLINE通知でアラート
- 上限到達時は「クレジットが上限に達しました」と案内
- 決済機能は未実装（α版は全ユーザーTrialプラン）
...
| 機能 | Trial | Light | Pro |
|---|---|---|---|
| 定型コマンド（予定・タスク・未読等） | 無料 | 無料 | 無料 |
| ブリーフィング（朝・昼・夜） | 無料 | 無料 | 無料 |
| メール分類 | 無料 | 無料 | 無料 |
| 移動リマインド | 無料 | 無料 | 無料 |
| 急ぎメール検索 | - | 無料 | 無料 |
| ダッシュボードAI返信生成 | 1cr | 1cr | 1cr |
| AI自由対話・カレンダー登録 | 1cr | - | 1cr |
