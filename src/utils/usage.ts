...
export async function checkAndNotifyUsageAlert(
  ...
  try {
    ...
    if (used !== threshold + 1) return; // ちょうど80%超えた瞬間だけ

    const remaining = limit - used;
    const resetDate = getResetDate();
    const label = actionType === "conversation" ? "AI\u5BFE\u8A71" : "AI\u8FD4\u4FE1\u751F\u6210";
    ...
    await client.pushMessage({
      ...
      messages: [{
        type: "text",
        text: `\u26A0\uFE0F ${label}\u306E\u6B8B\u308A\u56DE\u6570\u304C\u5C11\u306A\u304F\u306A\u3063\u3066\u3044\u307E\u3059\n\n\u4ECA\u6708\u306E\u4F7F\u7528\uFF1A${used}\u56DE / ${limit}\u56DE\n\u6B8B\u308A\uFF1A${remaining}\u56DE\n\u30EA\u30BB\u30C3\u30C8\u65E5\uFF1A${resetDate}\n\n\u30D7\u30ED\u30D7\u30E9\u30F3\u306B\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u3059\u308B\u3068${proLimit}\u56DE/\u6708\u3054\u5229\u7528\u3044\u305F\u3060\u3051\u307E\u3059\u3002`,
      }],
    });
  } catch (err) {
